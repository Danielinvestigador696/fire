...
-- MySQL Schema para Hostinger
-- ATENÇÃO: Este arquivo não cria o banco de dados, apenas as tabelas
-- Use este arquivo quando o banco já existe (como na Hostinger)
