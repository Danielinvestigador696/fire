...
-- ATENÇÃO: Se você já executou schema-hostinger.sql, a coluna role já existe
-- Nesse caso, use o arquivo 002_add_subscriptions_fixed.sql que verifica antes de adicionar
...
SET @sql = IF(@col_exists = 0,
  ...
  'SELECT "Coluna role já existe, pulando..." AS mensagem'
);
